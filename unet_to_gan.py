...
def generator_model():
    ...
    c6 = layers.SeparableConv2D(128, (3, 3), kernel_initializer = 'he_normal', padding = 'same')(u6)
    ...
    c7 = layers.SeparableConv2D(64, (3, 3), kernel_initializer = 'he_normal', padding = 'same')(u7)
